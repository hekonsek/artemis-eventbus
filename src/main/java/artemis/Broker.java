...
public class Broker {
        ...
        return new ArtemisConfigurationCustomizer(){
            public void customize(Configuration configuration) {
                try {
                    ...
                    configuration.addAddressesSetting("#", new AddressSettings().setAutoCreateJmsQueues(true));
                } catch (Exception e) {
    ...
    RoutesBuilder amqpRoute() {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from("amqp:jms.queue.foo").log("hello!");
            }
        };
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        Object response = producer.requestBody("amqp:jms.queue.foo", "xxx");
